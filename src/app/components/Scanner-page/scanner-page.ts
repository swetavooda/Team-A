...
export class scannerpage extends Observable {
  public message: string;
  private barcodeScanner: BarcodeScanner;

  constructor() {
    super();
    console.log("entered into scanner page");
  ...
  public doScanWithBackCamera() {
      console.log("Scanner function is called");
    this.scan(false, true,true);
  }
  ...
  private scan(front: boolean, flip: boolean, torch?: boolean, orientation?: string) {
    this.barcodeScanner.scan({
      ...
      message: "SMG's Crime Free Bharath", // Android only, default is 'Place a barcode inside the viewfinder rectangle to scan it.'
      ...
      closeCallback: () => {
        ...
        function (result) {
          ...
          setTimeout(function () {
            ...
            alert({
              title: "Scaned Successfully Result:",
